...
The comparison shows no major difference but if one looks at the mean values the split into two groups from the previous section is visible again (\autoref{fig:velocity-energy-low-mean}).
