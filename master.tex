...
% \input{isothermal-full-f-gyrofluid-equations.tex}


\section{Fluid Dynamics}
\label{sec:fluid-dynamics}
\subfile{fluid-dynamics}
% \input{fluid-dynamics.tex}
